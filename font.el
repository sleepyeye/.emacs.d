...
;; Korean font configuration (priority order: Apple SD Gothic Neo → IBM Plex → Noto Sans)
;; Apple SD Gothic Neo is the native macOS Korean font (San Francisco Korean)
(set-fontset-font t 'hangul "Apple SD Gothic Neo" nil 'prepend)

;; Fallback chain for Korean
(set-fontset-font t 'hangul "IBM Plex Sans KR" nil 'append)
(set-fontset-font t 'hangul "Noto Sans CJK KR" nil 'append)

;; Other East-Asian fontsets
